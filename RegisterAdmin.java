...
class RegisterAdmin
	...
	public RegisterAdmin()
	{
		...
		male.setFont(new Font("Arial", Font.PLAIN, 25));
		...
		female.setFont(new Font("Arial", Font.PLAIN, 25));
		...
		tadd = new JTextArea();
		tadd.setFont(new Font("Arial", Font.PLAIN, 25));
		tadd.setSize(200, 75);
...
//Driver Code
	...
	{
		RegisterAdmin f = new RegisterAdmin();
	}
}
